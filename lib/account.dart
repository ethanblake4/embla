...
class _AccountPageState extends State<AccountPage> {
  ...
  void initState() {
    super.initState();
    var app = AppState();
    if(new DateTime.now().millisecondsSinceEpoch > app.accountDocLastUpdate + 40 * 1000
      || app.forceAccountDocUpdate) {
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: <Widget>[
        ...
        Center(child: Text("I like to drink tea sometimes, sometimes not.", style: Theme.of(context).textTheme.caption)),
        Padding(padding: EdgeInsets.only(top: 16.0, left: 25.0, bottom: 12.0), child:
        Text(
          "My Community Items " + (AppState().accountDoc == null ? "" :
      ...
      return Card(
        ...
        children: [
          ...
          Column( crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
            ...
            Text(it['downloads'].toString() + " downloads", style: Theme.of(context).textTheme.caption),
          ],)
        ]
      ), onTap: () {
          Navigator.of(context).push(new MaterialPageRoute(builder: (ctx) => CommunityItemPage(image: it['image'])));
        },));
    });
  }
